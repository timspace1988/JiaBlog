       ...
       <div class="pull-left">
         <ul class="breadcrumb">
           @foreach ($breadcrumbs as $path => $disp)
             <li><a href="{{ route('admin.upload.index', ['folder' => $path]) }}">{{ $disp }}</a></li>
           @endforeach
       ...
       <table id="uploads-table" class="table table-striped table-bordered">
         ...
         <tbody>
           ...
           @foreach($subfolders as $path => $name)
             <tr>
               <td>
                 <a href="{{ route('admin.upload.index', ['folder' => $path]) }}">
...
@section('scripts')
  <script>
    ...
    //Startup code (apply jQuery's DataTable plugin)
    $(function(){
