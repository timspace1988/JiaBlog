        ...
        <table id="tags-table" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th class="hidden-sm">Page Image</th>
              <th class="hidden-sm">Meta Description</th>
          ...
          <tbody>
            @foreach ($tags as $tag)
              <tr>
                ...
                <td class="hidden-sm">{{ $tag->page_image }}</td>
                <td class="hidden-sm">{{ $tag->meta_description }}</td>
                ...
                <td>
                  <a href="{{ route('admin.tag.edit', $tag->id)}}" class="btn btn-xs btn-info">
