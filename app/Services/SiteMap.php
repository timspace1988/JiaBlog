...
{
    /**
     * Return the content of Site Map
     */
    ...
    protected function getPostsInfo(){
        return Post::where('published_at', '<=', Carbon::now())
          ...
          ->all();
          //->lists($value, $key) Note:'updated_at' and 'created_at' are defaultly creared by Eloquent ,
          //If you do not wish to have these columns automatically managed by Eloquent,
          //set the $timestamps property on your model to false:public $timestamps = false;
    }
